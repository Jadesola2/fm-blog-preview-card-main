...
For this project, I learned to use the border-radius and box-shadow properties in CSS 

### Continued development

For future projects, I hope to use the features learned in this project to implement more complex designs
